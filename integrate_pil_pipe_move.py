...
class DepthCalculator:
    def __init__(self):
        ...
        self.distance_pub = rospy.Publisher('/custom_node/pipe_distance', Float32, queue_size=20)
        self.pixel_x_pub = rospy.Publisher('/custom_node/pipe_pixel_x', UInt16, queue_size=20)
        self.pixel_y_pub = rospy.Publisher('/custom_node/pipe_pixel_y', UInt16, queue_size=20)
